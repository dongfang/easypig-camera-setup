...
#/usr/bin/ffmpeg -i "rtsp://admin:Xi80Smatso@192.168.0.132/medias2" -vcodec copy -map 0 -t 60 -f mp4 /tmp/cam132.mp4

CAMERA_URL="rtsp://admin:Xi80Smatso@192.168.0.132/medias2"
...
VIDEO_COMMAND="/usr/bin/ffmpeg -y -i ${CAMERA_URL} -vcodec copy -map 0 -t ${VIDEO_LENGTH} -f mp4"
